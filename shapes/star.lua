  ...
  if params.strokes == false then
	...
	local function drawPolygon(i)
		...
		elseif fractions == 5 then	
          ...
          vertices[3 * (i + 1) - 1], vertices[3 * (i + 1)]
        };
		...
		elseif fractions == 2 then
          ...
          vertices[2 * (i + 4) - 1], vertices[2 * (i + 4)], 
          linePoints[2 * (i + 1) - 1], linePoints[2 * (i + 1)]
        };
				shadedCenter = {
